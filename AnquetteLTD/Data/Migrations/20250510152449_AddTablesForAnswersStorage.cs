...
{
    /// <inheritdoc />
    public partial class AddTablesForAnswersStorage : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submissions_Anquettes_AnquetteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmissionAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionAnswers_AnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_AnquetteId",
                table: "Submissions",
                column: "AnquetteId");
        }
